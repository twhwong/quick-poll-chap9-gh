 ...
 */
/*
@ControllerAdvice apply by default globally to all Controllers.
 for classes that declare @ExceptionHandler, @InitBinder,
...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    // Without this annotation Spring will use its own exception response and not this one.
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException manve,
       ...
       // }
        ...
        // create valiationError instances
